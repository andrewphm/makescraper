...
[![Go Report Card](https://goreportcard.com/badge/github.com/andrewphm/makescraper)](https://goreportcard.com/report/github.com/andrewphm/makescraper)
...
2. Run each command line-by-line in your terminal to set up the project:
    ...
    $ git remote add origin git@github.com:andrewphm/makescraper.git
    $ go mod download
    ```
